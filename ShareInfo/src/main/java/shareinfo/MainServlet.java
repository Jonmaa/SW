...
public class MainServlet extends HttpServlet{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
    	...
    	if(request.getSession(false) == null) {
			...
			/*
			 * if(message!= null) { HttpSession session = request.getSession(); String
			 * sessionID = session.getId(); ServletContext context =
			 * request.getServletContext();
			 * 
			 * HashMap<String, String> loggedinUsers = (HashMap)
			 ...
			 * if(entry.getValue().equals(sessionID)) { String username = entry.getKey();
			 * mySQLdb.setMessageInfo(message, username); break; } } }
			 */
