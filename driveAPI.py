...
print("\nStep 6.- Create a new file in Drive")
...
print("\nStep 7.- List all files from Drive")
# Calendar API: https://developers.google.com/calendar/v3/reference
# CalendarList: https://developers.google.com/calendar/v3/reference#CalendarList
# CalendarList:list: https://developers.google.com/calendar/v3/reference/calendarList/list
...
print("\n Step 8.- Export a file from Drive")
uri = ("https://www.googleapis.com/drive/v3/files/1B4gwSqqfws8ojNdTZPHgTyJIFFztpgL6rMRJRTESl8E/export?mimeType=text/plain")
cabeceras = {'Authorization': "Bearer " + acces_token,
             'Accept': 'application/json'}
...
print("\n Step 9.- Share a file from Drive")
uri = "https://www.googleapis.com/drive/v3/files/1B4gwSqqfws8ojNdTZPHgTyJIFFztpgL6rMRJRTESl8E/permissions"
cabeceras = {'Authorization': "Bearer " + acces_token,
             'Accept': 'application/json',
...
datos = {
  "role": "writer",
  "type": "user",
  "emailAddress": "enekoetxanizmonge@gmail.com",
  "emailMessage": "Eneko comprame el Stardew Valley"
}
